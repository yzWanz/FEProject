    ...
    <div class="group_1 flex-col">
      <div class="box_1 flex-col">
          ...
          <div class="group_9 flex-row">
            ...
            <div class="block_2 flex-col">
              ...
              <div class="block_5 flex-col">
                <div class="text-wrapper_5 flex-row justify-between">
                  <span class="text_26">电量</span>
                  <span class="text_27">70</span>
                </div>
                <div class="image-text_7 flex-row justify-between">
                  <span class="text-group_7">信号强度</span>
                  <img
                    class="image_44"
                    referrerpolicy="no-referrer"
                    src="./assets/img/SketchPngaa96de67971f4771da7e8016c3b81da3a047b183bb2aa82a2842530dfb0cf3ee.png"
                ...
                <div class="image-text_8 flex-row justify-between">
                  <span class="text-group_8">光纤开关</span>
                  <img
                    class="image_46"
                    referrerpolicy="no-referrer"
                    src="./assets/img/SketchPngdd0cd68db5fd8fc34c80fbcaf429881df099667b9292232a8eee75cef13acf88.png"
                ...
                <div class="image-text_9 flex-row justify-between">
                  <span class="text-group_9">WIFI开关</span>
                  <img
                    class="image_47"
                    referrerpolicy="no-referrer"
                    src="./assets/img/SketchPng05e84e5262baec27f72b659fbb700441b06de2845fce34f260ceecc078cafd56.png"
              ...
              <div class="block_6 flex-row">
                ...
                <img
                  ...
                  src="./assets/img/SketchPng5b84bc7480ddb4d2955c0d00c296692274a0ce550004da74d07355c0a68b1970.png"
                />
                <span class="text_29">传感器&nbsp;08</span>
              </div>
              ...
              <div class="block_7 flex-col">
                ...
                <div class="image-text_10 flex-row justify-between">
                  <span class="text-group_10">信号强度</span>
                  <img
                    class="image_52"
                    referrerpolicy="no-referrer"
                    src="./assets/img/SketchPngaa96de67971f4771da7e8016c3b81da3a047b183bb2aa82a2842530dfb0cf3ee.png"
                ...
                <div class="image-text_11 flex-row justify-between">
                  <span class="text-group_11">光纤开关</span>
                  <img
                    class="image_54"
                    referrerpolicy="no-referrer"
                    src="./assets/img/SketchPngdd0cd68db5fd8fc34c80fbcaf429881df099667b9292232a8eee75cef13acf88.png"
                ...
                <div class="image-text_12 flex-row justify-between">
                  <span class="text-group_12">WIFI开关</span>
                  <img
                    class="image_55"
                    referrerpolicy="no-referrer"
                    src="./assets/img/SketchPng05e84e5262baec27f72b659fbb700441b06de2845fce34f260ceecc078cafd56.png"
            ...
            <div class="block_8 flex-col">
              <div class="group_11 flex-col">
                <div class="text-wrapper_7 flex-row justify-between">
                  <span class="text_33">电量</span>
                  <span class="text_34">70</span>
                </div>
                <div class="box_11 flex-row justify-between">
                  <span class="text_35">信号强度</span>
                  <img
                    class="image_56"
                    referrerpolicy="no-referrer"
                    src="./assets/img/SketchPngaa96de67971f4771da7e8016c3b81da3a047b183bb2aa82a2842530dfb0cf3ee.png"
                ...
                <div class="box_14 flex-row justify-between">
                  <span class="text_38">WIFI开关</span>
                  <img
                    class="image_59"
                    referrerpolicy="no-referrer"
                    src="./assets/img/SketchPng05e84e5262baec27f72b659fbb700441b06de2845fce34f260ceecc078cafd56.png"
              ...
              <div class="group_12 flex-row">
                ...
                <img
                  ...
                  src="./assets/img/SketchPng5b84bc7480ddb4d2955c0d00c296692274a0ce550004da74d07355c0a68b1970.png"
                />
                <span class="text_39">传感器&nbsp;06</span>
              </div>
              ...
              <div class="group_13 flex-col">
                <div class="text-wrapper_8 flex-row justify-between">
                  <span class="text_40">电量</span>
                  <span class="text_41">70</span>
                </div>
                <div class="image-text_13 flex-row justify-between">
                  <span class="text-group_13">信号强度</span>
                  <img
                    class="image_64"
                    referrerpolicy="no-referrer"
                    src="./assets/img/SketchPngaa96de67971f4771da7e8016c3b81da3a047b183bb2aa82a2842530dfb0cf3ee.png"
                ...
                <div class="image-text_14 flex-row justify-between">
                  <span class="text-group_14">光纤开关</span>
                  <img
                    class="image_66"
                    referrerpolicy="no-referrer"
                    src="./assets/img/SketchPngdd0cd68db5fd8fc34c80fbcaf429881df099667b9292232a8eee75cef13acf88.png"
                ...
                <div class="image-text_15 flex-row justify-between">
                  <span class="text-group_15">WIFI开关</span>
                  <img
                    class="image_67"
                    referrerpolicy="no-referrer"
                    src="./assets/img/SketchPng05e84e5262baec27f72b659fbb700441b06de2845fce34f260ceecc078cafd56.png"
            ...
            <div class="block_9 flex-col">
              ...
              <div class="box_15 flex-col">
                ...
                />
                <div class="box_16 flex-col align-center">
              ...
              <div class="box_17 flex-col">
                <div class="text-wrapper_9 flex-row justify-between">
                  <span class="text_43">IP地址</span>
                  <span class="text_44">172.168.0.1</span>
                </div>
                <div class="text-wrapper_10 flex-row justify-between">
                  <span class="text_45">MAC地址</span>
                  <span class="text_46">172.168.3.4</span>
                </div>
                <div class="box_18 flex-row justify-between">
                  <span class="text_47">信号强度</span>
                  <img
                    class="image_73"
                    referrerpolicy="no-referrer"
              ...
              <div class="box_19 flex-row">
                ...
                />
                <div class="section_9 flex-col align-center">
              ...
              <div class="box_20 flex-col">
                <div class="text-wrapper_11 flex-row justify-between">
                  <span class="text_48">电量</span>
                  <span class="text_49">70</span>
                </div>
                <div class="block_10 flex-row">
                  <div class="image-text_16 flex-row justify-between">
                    <span class="text-group_16">声音</span>
                    <img
                      class="thumbnail_13"
                      referrerpolicy="no-referrer"
                ...
                <div class="block_12 flex-row justify-between">
                  <div class="image-text_17 flex-row justify-between">
                    <span class="text-group_17">光纤开关</span>
                    <img
                      class="image_80"
                      referrerpolicy="no-referrer"
                      src="./assets/img/SketchPng172bfeb456bb3fad5648576e69623029b7607dbb2fdc7a3bd9b731f66c0d0c8e.png"
                  ...
                  <div class="image-text_18 flex-row justify-between">
                    <span class="text-group_18">WIFI开关</span>
                    <img
                      class="image_81"
                      referrerpolicy="no-referrer"
              ...
              <div class="box_21 flex-col">
                ...
                />
                <div class="group_15 flex-col align-center">
              ...
              <div class="box_22 flex-row">
                <div class="text-group_19 flex-col justify-between">
                  <span class="text_51">设备序列号</span>
                  <span class="text_52">软件版本号</span>
                  <span class="text_53">硬件版本号</span>
                </div>
                <div class="text-group_20 flex-col justify-between">
                  <span class="text_54">APTX&nbsp;69391</span>
                  <span class="text_55">V1.0.1</span>
                  <span class="text_56">Matrix001.372</span>
                </div>
              </div>
              <img
                class="image_87"
              ...
              <div class="box_23 flex-row">
                ...
                />
                <div class="box_24 flex-col align-center">
              ...
              <div class="box_25 flex-row">
                <div class="text-group_21 flex-col justify-between">
                  <span class="text_57">数据源</span>
                  <span class="text_58">数据内容</span>
                </div>
                <div class="text-group_22 flex-col justify-between">
                  <span class="text_59">wikipedia</span>
                  <span class="text_60">
                    这里是一段很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长的数据内容
                  </span>
                </div>
              </div>
              <span class="text_61">网络连接信息</span>
              <span class="text_62">设备信息</span>
              <span class="text_63">设备模组状态</span>
              <span class="text_64">数据接收</span>
            </div>
          </div>
          <img
            class="image_92"
        ...
        <div class="group_16 flex-row">
          <div class="text-wrapper_12 flex-col"><span class="text_65">可靠通信</span></div>
          ...
          <div class="text-wrapper_13 flex-col"><span class="text_66">探测值守</span></div>
          ...
          <div class="group_21 flex-row">
            ...
            />
            <span class="text_68">多元信息综合处理与辅助决策平台</span>
          </div>
          ...
          />
          <div class="text-wrapper_14 flex-col"><span class="text_69">定位导航</span></div>
          <div class="text-wrapper_15 flex-col"><span class="text_70">光纤平台</span></div>
          <div class="text-wrapper_16 flex-col"><span class="text_71">空间建模</span></div>
          <div class="text-wrapper_17 flex-col"><span class="text_72">无人车控制</span></div>
        </div>
      </div>
    </div>
  </div>
